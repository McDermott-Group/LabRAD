...
class SIM921Server(GPIBManagedServer):
    """Provides basic control for SRS 922 AC Resistance Bridge Module"""
    name = 'SIM921 Server'
    deviceName = 'Stanford_Research_Systems SIM921' #Stanford_Research_Systems,SIM921,s/n105794,ver3.6\n
